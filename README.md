...
* sonar\_\_web\_\_accessLogs\_\_pattern=combined
  * Format of access log. It is ignored if sonar\_\_web\_\_accessLogs\_\_enable=false
...
* sonar\_\_search\_\_httpPort=9010
  * Uncomment to enable the Elasticsearch HTTP connector, so that ES can be directly requested through http://lmenezes\_\_com/elasticsearch-kopf/?location=http://localhost:9010
